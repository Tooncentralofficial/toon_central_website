      ...
      <div className="">
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex justify-between items-center">
            <div className="flex items-center">
              <Checkbox
                radius="sm"
                checked={formik.values.remembered}
                color="success"
                onValueChange={(selected) =>
                  formik.setFieldValue("remembered", selected)
                }
              />
              Remember Me
            </div>
            <Link href="/auth/reset">
              <span className="text-[var(--green100)]">Forgot password?</span>
            </Link>
          </div>
        </div>
        <SolidPrimaryButton
        ...
        <div className="flex gap-1 text-md justify-center mt-2">
          ...
          <Link href="/auth/signup">
            <span className="text-[var(--green100)]">Create account</span>
          </Link>
        </div>
      </div>
    </form>
