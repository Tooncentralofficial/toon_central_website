...
export default function ShortsContent({
  ...
  // Mock featured data with stock images
  {
    ...
    description: "Join us on an enchanting adventure through the lush green forest and discover hidden secrets.",
  ...
  },
  {
    ...
    description: "Experience the nightlife of the city as the lights shimmer and stories unfold.",
  ...
  },
  {
    ...
    uuid: "featured-4",
    title: "Desert Mirage",
    description: "Walk through the sands and uncover the mystery of the everlasting dunes.",
  ...
  },
  {
    ...
    uuid: "featured-5",
    title: "Ocean Depths",
    description: "Dive into the blue and find the unexpected wonders that lie beneath the surface.",
  ...
  return (
    <div className="w-full h-full "> 
      ...
      <ShortsCard short={featuredShortsData[0]} featured={true} index={0} />
    </div>
  );
}
